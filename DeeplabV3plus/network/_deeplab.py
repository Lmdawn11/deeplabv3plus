...
from DeeplabV3plus.network.utils import _SimpleSegmentationModel
from DeeplabV3plus.network.DAnet import DANetHead
...
class MASPP(nn.Module):
    def __init__(self, in_channels, aspp_dilate=[12, 24, 36]):
        ...
        self.aspp2 = ASPP(in_channels, aspp_dilate)
        self.aspp3 = ASPP(in_channels, aspp_dilate)
        self.aspp4 = ASPP(in_channels, aspp_dilate)
        self.aspp5 = ASPP(in_channels, aspp_dilate)
