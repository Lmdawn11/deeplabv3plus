...
from DeeplabV3plus.network.backbone.DnCNN_noiseprint import make_net
from DeeplabV3plus.network.backbone.srm_bayer import SRMFilter, BayarConv2d
import logging
import os
...
if __name__ == '__main__':
    modal_ext = ModalitiesExtractor(['noiseprint', 'bayar', 'srm'], '/root/autodl-tmp/DeeplabV3plus/checkpoints/noiseprint/np++.pth')
