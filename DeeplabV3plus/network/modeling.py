from DeeplabV3plus.network.utils import IntermediateLayerGetter
from ._deeplab import DeepLabHead, DeepLabHeadV3Plus, DeepLabV3, DualStreamModel
...
from .backbone.noise_srm_bayer_backbone import resnet50noise
...
def _segm_resnet(name, backbone_name, num_classes, output_stride, pretrained_backbone):
    ...
    extractor_noise_srm_bayer = resnet50noise()
    inplanes = 2048
    ...
    extractor = IntermediateLayerGetter(extractor_noise_srm_bayer, return_layers=return_layers)

    dualStreamModel = DualStreamModel(backbone, extractor,return_layers = return_layers)

    model = DeepLabV3(dualStreamModel, classifier)
